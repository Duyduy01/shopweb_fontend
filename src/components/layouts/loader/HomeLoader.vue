<template>
  <div class="loading p-fixed w-100 h-100 left-0" v-if="!isLoaded">
    <div class="ctnr">
      <!-- <div class="loading_header xs-flex ai-center">
        <div class="loading_header_img">
          <span class="xs-block"></span>
        </div>
        <div class="loading_header_icon xs-flex ai-center">
          <span class="xs-block"></span>
          <span class="xs-block"></span>
          <span class="xs-block"></span>
          <span class="xs-block"></span>
      ...
      <div>
        <div class="loading_title">
          <span class="block xs-block"></span>
        </div>
        <div class="row">
          <div class="col-6 col-sm-4 col-lg-3" id="card">
            <div class="card-image p-relative">
              <!-- <div class="block pulsate"></div> -->
              <svg
                class="fpo p-absolute"
                width="84px"
                height="63px"
                x="50%"
                y="50%"
            ...
            <div class="card-content">
              ...
              <div class="card-content-price xs-flex js-between">
                <div class="block3 pulsate"></div>
                <div class="block4 pulsate"></div>
              </div>
          ...
          <div class="xs-none sm-block col-6 col-sm-4 col-lg-3">
            <div class="card-image p-relative">
              <!-- <div class="block pulsate"></div> -->
              <svg
                class="fpo p-absolute"
          ...
          <div class="xs-none lg-block col-6 col-sm-4 col-lg-3">
            <div class="card-image p-relative">
              <!-- <div class="block pulsate"></div> -->
              <svg
                class="fpo p-absolute"
        ...
        <div class="loading_title title_second">
          <span class="block xs-block"></span>
        </div>
        <div class="row">
          <div class="col-6 col-sm-4 col-lg-3" id="card">
...
.loading_header_img span {
  width: 6rem;
  height: 6rem;
}
.loading_header_icon span {
  width: 3.5rem;
  height: 3.5rem;
  background: linear-gradient(-45deg, #dddddd, #f0f0f0, #dddddd, #f0f0f0);
  background-size: 400% 400%;
  -webkit-animation: Gradient-data-v-6132f388 2.25s ease infinite;
  animation: Gradient-data-v-6132f388 2.25s ease infinite;
}
.loading_header_icon span:not(:last-child) {
  margin-right: 1rem;
} */
/*------------------------------------*/
/* loading body */
