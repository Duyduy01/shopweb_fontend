<template>
  <div class="loading p-absolute w-100 h-100 top-0 left-0" v-if="!isLoaded">
    <div class="row" ref="childDiv">
      <div class="card-wrapper col-6 col-sm-4">
      ...
      <div class="card-wrapper xs-none sm-block col-sm-4">
        <div class="card-image p-relative">
          <!-- <div class="block pulsate"></div> -->
          <svg
            class="fpo p-absolute"
...
export default {
  ...
  methods: {
    getHeight() {
      return this.$refs.childDiv.offsetHeight; // Trả về chiều cao của phần tử
    }
  },
};
</script>
