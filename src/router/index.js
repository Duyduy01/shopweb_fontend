...
const routes = [{
  ...
  },
  {
    ...
    children: [{
      path: '/chi-tiet-san-pham/:productId',
      name: 'product-detail',
      component: () => import('@/views/user/product/ProductDetailUserView.vue'),
      meta: {
  ...
  },
  {
    ...
    children: [{
      path: '/tim-kiem',
      name: 'tim-kiem',
      component: () => import('@/views/user/product/SearchProductUserView.vue'),
      props: true,
      meta: {
        title: 'Tìm kiếm'
      },
  ...
  },
  {
    ...
    children: [{
      ...
      component: () => import('@/views/admin/product/AdminProductAddMainView.vue'),
      meta: {
        authorize: [Role.Admin, Role.SupAmdin],
        requiresAuth: true,
        title: 'Admin product'
  ...
  },
  {
    ...
    children: [{
      ...
      component: () => import('@/views/admin/campaign/AdminCampaignDetailView'),
      meta: {
        authorize: [Role.Admin, Role.SupAmdin],
        requiresAuth: true,
  ...
  // add campagin detail
  {
    ...
    children: [{
      ...
      component: () => import('@/views/admin/campaign/AdminCampaignDetailAddView'),
      meta: {
        authorize: [Role.Admin, Role.SupAmdin],
        requiresAuth: true,
        title: 'Admin campaign detail'
  ...
  },
  {
    ...
    children: [{
      ...
      component: () => import('@/views/admin/campaign/AdminCampaignFinishView'),
      meta: {
        authorize: [Role.Admin, Role.SupAmdin],
        requiresAuth: true,
  ...
  },
  {
    ...
    children: [{
      ...
      component: () => import('@/views/admin/report/AdminReportSeveralDays.vue'),
      meta: {
        authorize: [Role.Admin, Role.SupAmdin],
        requiresAuth: true,
        title: 'Admin report'
